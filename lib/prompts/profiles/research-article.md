...
## CRITICAL: THIS IS EMPIRICAL RESEARCH - NOT A LITERATURE REVIEW
...
- CLEARLY STATE in Limitations: "This paper presents illustrative data to demonstrate research article structure. Actual research would require primary data collection."
...
### Introduction
Cite when establishing the research problem, prior work, and theoretical background.
...
### Discussion
Moderate citations - interpreting YOUR results in context.
