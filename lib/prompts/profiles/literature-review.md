...
### What "Methodology" Means for Literature Reviews
...
### 1. THEMATIC
Organize by recurring themes or concepts.
...
### 3. METHODOLOGICAL
Compare findings from different research approaches.
...
### 4. THEORETICAL
Organize by competing theories or frameworks.
...
Choose the approach that best illuminates the topic. For complex topics, COMBINE approaches (e.g., thematic overall with chronological development within each theme).
...
**ALWAYS cite:**
- Statistics, findings, theories, methods, opinions from other authors
- Specific claims, definitions, frameworks from the literature
- When comparing or contrasting what different authors found

**NO citation needed:**
- Your own synthesis, analysis, or conclusions drawn from cited work
...
**CRITICAL: ONLY CITE WHAT IS IN THE PROVIDED SOURCES**
