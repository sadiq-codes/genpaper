 ...
 * - Levenshtein distance for character-level matching (using fastest-levenshtein)
 ...
 * Uses fastest-levenshtein library (~10x faster than custom implementation)
 */
export function levenshteinDistance(str1: string, str2: string): number {
  return fastLevenshtein(str1, str2)
}
