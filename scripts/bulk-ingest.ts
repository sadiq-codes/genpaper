...
// Domains known to allow programmatic PDF downloads
// These are truly open access repositories that don't block automated requests
const PDF_FRIENDLY_DOMAINS = [
  // === PREPRINT SERVERS ===
  // arXiv - physics, math, CS, biology, etc.
  'arxiv.org',
  'www.arxiv.org',
  'export.arxiv.org',
  ...
  'chemrxiv.org',
  'www.chemrxiv.org',
  // EarthArXiv - earth sciences preprints
  'eartharxiv.org',
  'www.eartharxiv.org',
  ...
  'psyarxiv.com',
  'www.psyarxiv.com',
  // SocArXiv - social sciences preprints
  'socarxiv.org',
  'osf.io',  // OSF hosts many preprint servers
  // ESSOAr - earth/space science preprints (AGU)
  'essoar.org',
  'www.essoar.org',
  ...
  // SSRN - social sciences (now Elsevier, but still allows downloads)
  'ssrn.com',
  'www.ssrn.com',
  'papers.ssrn.com',
  ...
  // === INSTITUTIONAL/GENERAL REPOSITORIES ===
  // Zenodo - CERN's general-purpose repository
  'zenodo.org',
  'www.zenodo.org',
  // Figshare - general repository
  'figshare.com',
  'www.figshare.com',
  // Dryad - data repository (also papers)
  'datadryad.org',
  'www.datadryad.org',
  ...
  // === GOLD OA PUBLISHERS ===
  // MDPI - large OA publisher
  'www.mdpi.com',
  'mdpi.com',
  // Frontiers - OA publisher
  'www.frontiersin.org',
  'frontiersin.org',
  // PLOS - pioneer OA publisher
  'journals.plos.org',
  'www.plos.org',
  // PeerJ - OA publisher
  'peerj.com',
  'www.peerj.com',
  // eLife - prestigious OA journal
  'elifesciences.org',
  'www.elifesciences.org',
  // Hindawi - OA publisher (now Wiley)
  'hindawi.com',
  'www.hindawi.com',
  // BioMed Central (BMC)
  'biomedcentral.com',
  ...
  'f1000research.com',
  'www.f1000research.com',
  // GigaScience
  'gigasciencejournal.com',
  'academic.oup.com',  // OUP OA papers
  // Nature portfolio (OA papers)
  'www.nature.com',
  'nature.com',
  // Royal Society
  ...
  // AIP Advances
  'aip.scitation.org',
  // Copernicus Publications (earth sciences)
  'copernicus.org',
  'www.copernicus.org',
  
  // === REGIONAL OA PLATFORMS ===
  // SciELO - Latin America, Iberian Peninsula, South Africa
  'www.scielo.br',
  'scielo.br',
  'www.scielo.cl',
  'scielo.cl',
  ...
  'www.scielo.org.pe',
  'www.scielo.pt',
  'www.scielo.org.za',  // South Africa
  ...
  // E-LIS - library science
  'eprints.rclis.org',
  // LingBuzz - linguistics
  'ling.auf.net',
  // CogPrints - cognitive sciences (legacy)
  'cogprints.org',
  // CORE - aggregator (may work)
  'core.ac.uk',
  
  // === INSTITUTIONAL REPOS (COMMON PLATFORMS) ===
  // Many universities use DSpace, EPrints, or Digital Commons
  // These domain patterns catch many institutional repos
  'dspace.mit.edu',
  'dash.harvard.edu',
  'escholarship.org',  // California Digital Library
...
/**
 * Check if a PDF URL is from a domain known to allow programmatic downloads
 */
function isPdfFriendlyDomain(url: string): boolean {
  try {
