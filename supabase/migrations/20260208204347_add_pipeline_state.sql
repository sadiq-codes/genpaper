...
-- This enables background workers to store intermediate state between steps, allowing long-running
...
'Stores intermediate pipeline state between generation steps. Includes: profile, paperIds, extractionProgress, themeAnalysis, contexts, sectionResults, qualityIssues. State is cleared on completion.';
