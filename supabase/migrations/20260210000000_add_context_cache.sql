...
-- Stores serialized section contexts between Inngest steps to avoid
...
COMMENT ON COLUMN generation_runs.context_cache IS 'Compressed (gzip+base64) section contexts cached between Inngest steps. Cleared on finalization.';
