...
## When to Cite Social Media in Academic Writing {#when-to-cite-social-media}
...
## APA Format for Social Media Citations {#apa-format}
...
## MLA Format for Social Media Citations {#mla-format}
...
## Chicago Format for Social Media Citations {#chicago-format}
...
## Platform-Specific Examples {#platform-examples}
